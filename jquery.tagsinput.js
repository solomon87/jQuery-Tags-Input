/*global window, jQuery, $, escape, unescape */
/*
	...
	$.fn.tagsInput = function(options) {
		...
		this.each(function() {
			...
			var data = jQuery.extend({
				pid:id,
				real_input: $(this),
				holder: $('<div id="'+id+'_tagsinput" class="tagsinput"/>'),
				input_wrapper: $('<div id="'+id+'_addTag"/>'),
				fake_input: $('<input id="'+id+'_tag" value="" data-default="'+settings.defaultText+'" />')
			},settings);
			...
			// Place tagsinput markup on the page after the selected input
			data.holder.append(data.input_wrapper.append(data.fake_input)).append($('<div class="tags_clear">')).insertAfter(this);
			...
			if (settings.interactive) {
				...
				if (settings.autocomplete_url !== undefined) {
					...
					for (var attrname in settings.autocomplete) {
						if (settings.autocomplete.hasOwnProperty(attrname))
